...
def ejecutar_actualizaciones():
    ...
    # Cargar el proyecto una vez al inicio
    RUTA_PROYECTO_PRO = r"C:\docsProyectos\5.RAISS\2024.0.RAISS_Lote_4\1.GIS\1.2.PRO\RAISS_Lote_4\RAISS_Lote_4.aprx"
    proyecto = arcpy.mp.ArcGISProject(RUTA_PROYECTO_PRO)
    ...
    actualizacion_exportacion_mapa(nombreMapa, nombreCapa, nombreCapaSimbologia, nombreLayout)

    # Segunda ejecución
    nombreMapa = 'Seguimiento Indicadores [Ha] Visitadas Fuente BCGS X UI Urbano'
    nombreCapa = 'Terrenos Radicados BCGS'
    nombreCapaSimbologia = 'estado_tramite'
    nombreLayout = nombreMapa
    actualizacion_exportacion_mapa(nombreMapa, nombreCapa, nombreCapaSimbologia, nombreLayout)

    # Guardar el proyecto solo al final
    proyecto.save()